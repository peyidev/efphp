...
this.wysihtml5 = this.wysihtml5 || {}, this.wysihtml5.tpl = this.wysihtml5.tpl || {}, this.wysihtml5.tpl.blockquote = Handlebars.template(function(a, b, c, d, e) {
    function f(a) {
        var b, c = "";
        return c += "btn-" + m((b = a && a.options, b = null == b || b === !1 ? b : b.size, typeof b === l ? b.apply(a) : b))
    }
    ...
    var i, j, k = "",
        ...
        n = this;
    return k += '<li>\n  <a class="btn ', j = c["if"].call(b, (i = b && b.options, null == i || i === !1 ? i : i.size), {
        hash: {},
        inverse: n.noop,
        fn: n.program(1, f, e),
        data: e
    }), (j || 0 === j) && (k += j), k += ' btn-default" data-wysihtml5-command="formatBlock" data-wysihtml5-command-value="blockquote" data-wysihtml5-display-format-name="false" tabindex="-1">\n    ', j = c["if"].call(b, (i = b && b.options, i = null == i || i === !1 ? i : i.toolbar, null == i || i === !1 ? i : i.fa), {
        hash: {},
    ...
    var i, j, k = "",
        ...
        m = this.escapeExpression,
        n = this;
    return k += '<li class="dropdown">\n  <a class="btn btn-default dropdown-toggle ', j = c["if"].call(b, (i = b && b.options, null == i || i === !1 ? i : i.size), {
        hash: {},
        inverse: n.noop,
        fn: n.program(1, f, e),
        data: e
    }), (j || 0 === j) && (k += j), k += '" data-toggle="dropdown">\n    ', j = c["if"].call(b, (i = b && b.options, i = null == i || i === !1 ? i : i.toolbar, null == i || i === !1 ? i : i.fa), {
        hash: {},
        inverse: n.program(5, h, e),
        fn: n.program(3, g, e),
        data: e
    ...
    return k += '<li>\n  <div class="btn-group">\n    <a class="btn ', j = c["if"].call(b, (i = b && b.options, null == i || i === !1 ? i : i.size), {
        ...
        fn: n.program(1, f, e),
        data: e
    }), (j || 0 === j) && (k += j), k += ' btn-default" data-wysihtml5-action="change_view" title="' + m((i = b && b.locale, i = null == i || i === !1 ? i : i.html, i = null == i || i === !1 ? i : i.edit, typeof i === l ? i.apply(b) : i)) + '" tabindex="-1">\n      ', j = c["if"].call(b, (i = b && b.options, i = null == i || i === !1 ? i : i.toolbar, null == i || i === !1 ? i : i.fa), {
        hash: {},
        inverse: n.program(5, h, e),
        fn: n.program(3, g, e),
        data: e
    ...
    function g(a) {
        var b, c = "";
        return c += "btn-" + n((b = a && a.options, b = null == b || b === !1 ? b : b.size, typeof b === m ? b.apply(a) : b))
    }
    ...
    var j, k, l = "",
        ...
        o = this;
    return l += '<li>\n  <div class="bootstrap-wysihtml5-insert-image-modal modal fade">\n    <div class="modal-dialog ', k = c["if"].call(b, (j = b && b.options, j = null == j || j === !1 ? j : j.toolbar, null == j || j === !1 ? j : j.smallmodals), {
        hash: {},
        inverse: o.noop,
        fn: o.program(1, f, e),
        data: e
    }), (k || 0 === k) && (l += k), l += '">\n      <div class="modal-content">\n        <div class="modal-header">\n          <a class="close" data-dismiss="modal">&times;</a>\n          <h3>' + n((j = b && b.locale, j = null == j || j === !1 ? j : j.image, j = null == j || j === !1 ? j : j.insert, typeof j === m ? j.apply(b) : j)) + '</h3>\n        </div>\n        <div class="modal-body">\n          <input value="http://" class="bootstrap-wysihtml5-insert-image-url form-control">\n        </div>\n        <div class="modal-footer">\n          <a class="btn btn-default" data-dismiss="modal">' + n((j = b && b.locale, j = null == j || j === !1 ? j : j.image, j = null == j || j === !1 ? j : j.cancel, typeof j === m ? j.apply(b) : j)) + '</a>\n          <a class="btn btn-primary" data-dismiss="modal">' + n((j = b && b.locale, j = null == j || j === !1 ? j : j.image, j = null == j || j === !1 ? j : j.insert, typeof j === m ? j.apply(b) : j)) + '</a>\n        </div>\n      </div>\n    </div>\n  </div>\n  <a class="btn ', k = c["if"].call(b, (j = b && b.options, null == j || j === !1 ? j : j.size), {
        hash: {},
        inverse: o.noop,
        fn: o.program(3, g, e),
        data: e
    }), (k || 0 === k) && (l += k), l += ' btn-default" data-wysihtml5-command="insertImage" title="' + n((j = b && b.locale, j = null == j || j === !1 ? j : j.image, j = null == j || j === !1 ? j : j.insert, typeof j === m ? j.apply(b) : j)) + '" tabindex="-1">\n    ', k = c["if"].call(b, (j = b && b.options, j = null == j || j === !1 ? j : j.toolbar, null == j || j === !1 ? j : j.fa), {
        hash: {},
        inverse: o.program(7, i, e),
        fn: o.program(5, h, e),
        data: e
    }), (k || 0 === k) && (l += k), l += "\n  </a>\n</li>\n"
    ...
    return l += '<li>\n  <div class="bootstrap-wysihtml5-insert-link-modal modal fade">\n    <div class="modal-dialog ', k = c["if"].call(b, (j = b && b.options, j = null == j || j === !1 ? j : j.toolbar, null == j || j === !1 ? j : j.smallmodals), {
        ...
        fn: o.program(3, g, e),
        data: e
    }), (k || 0 === k) && (l += k), l += ' btn-default" data-wysihtml5-command="createLink" title="' + n((j = b && b.locale, j = null == j || j === !1 ? j : j.link, j = null == j || j === !1 ? j : j.insert, typeof j === m ? j.apply(b) : j)) + '" tabindex="-1">\n    ', k = c["if"].call(b, (j = b && b.options, j = null == j || j === !1 ? j : j.toolbar, null == j || j === !1 ? j : j.fa), {
        hash: {},
        inverse: o.program(7, i, e),
        fn: o.program(5, h, e),
        data: e
    ...
    function f(a) {
        var b, c = "";
        return c += "btn-" + s((b = a && a.options, b = null == b || b === !1 ? b : b.size, typeof b === r ? b.apply(a) : b))
    }
    ...
    var o, p, q = "",
        ...
        t = this;
    return q += '<li>\n  <div class="btn-group">\n    <a class="btn ', p = c["if"].call(b, (o = b && b.options, null == o || o === !1 ? o : o.size), {
        hash: {},
        inverse: t.noop,
        fn: t.program(1, f, e),
        data: e
    }), (p || 0 === p) && (q += p), q += ' btn-default" data-wysihtml5-command="insertUnorderedList" title="' + s((o = b && b.locale, o = null == o || o === !1 ? o : o.lists, o = null == o || o === !1 ? o : o.unordered, typeof o === r ? o.apply(b) : o)) + '" tabindex="-1">\n    ', p = c["if"].call(b, (o = b && b.options, o = null == o || o === !1 ? o : o.toolbar, null == o || o === !1 ? o : o.fa), {
        hash: {},
        inverse: t.program(5, h, e),
        fn: t.program(3, g, e),
        data: e
    }), (p || 0 === p) && (q += p), q += '\n    </a>\n    <a class="btn ', p = c["if"].call(b, (o = b && b.options, null == o || o === !1 ? o : o.size), {
        hash: {},
        ...
        fn: t.program(1, f, e),
        data: e
    }), (p || 0 === p) && (q += p), q += ' btn-default" data-wysihtml5-command="insertOrderedList" title="' + s((o = b && b.locale, o = null == o || o === !1 ? o : o.lists, o = null == o || o === !1 ? o : o.ordered, typeof o === r ? o.apply(b) : o)) + '" tabindex="-1">\n    ', p = c["if"].call(b, (o = b && b.options, o = null == o || o === !1 ? o : o.toolbar, null == o || o === !1 ? o : o.fa), {
        hash: {},
        inverse: t.program(9, j, e),
        fn: t.program(7, i, e),
        data: e
    }), (p || 0 === p) && (q += p), q += '\n    </a>\n    <a class="btn ', p = c["if"].call(b, (o = b && b.options, null == o || o === !1 ? o : o.size), {
        hash: {},
        ...
        fn: t.program(1, f, e),
        data: e
    }), (p || 0 === p) && (q += p), q += ' btn-default" data-wysihtml5-command="Outdent" title="' + s((o = b && b.locale, o = null == o || o === !1 ? o : o.lists, o = null == o || o === !1 ? o : o.outdent, typeof o === r ? o.apply(b) : o)) + '" tabindex="-1">\n    ', p = c["if"].call(b, (o = b && b.options, o = null == o || o === !1 ? o : o.toolbar, null == o || o === !1 ? o : o.fa), {
        hash: {},
        inverse: t.program(13, l, e),
        fn: t.program(11, k, e),
        data: e
    }), (p || 0 === p) && (q += p), q += '\n    </a>\n    <a class="btn ', p = c["if"].call(b, (o = b && b.options, null == o || o === !1 ? o : o.size), {
        hash: {},
        ...
        fn: t.program(1, f, e),
        data: e
    }), (p || 0 === p) && (q += p), q += ' btn-default" data-wysihtml5-command="Indent" title="' + s((o = b && b.locale, o = null == o || o === !1 ? o : o.lists, o = null == o || o === !1 ? o : o.indent, typeof o === r ? o.apply(b) : o)) + '" tabindex="-1">\n    ', p = c["if"].call(b, (o = b && b.options, o = null == o || o === !1 ? o : o.toolbar, null == o || o === !1 ? o : o.fa), {
        hash: {},
        inverse: t.program(17, n, e),
        fn: t.program(15, m, e),
        data: e
    }), (p || 0 === p) && (q += p), q += "\n    </a>\n  </div>\n</li>\n"
}),

...
Base.extend = function(a, b) {
    ...
    function a(a, c) {
        ...
        var d, e, f, g = c.context || a.ownerDocument || document,
            ...
            i = "string" == typeof a;
        for (c.uneditableClass && (p = c.uneditableClass), d = i ? wysihtml5.dom.getAsDom(a, g) : a; d.firstChild;) f = d.firstChild, e = b(f, c.cleanUp), d.removeChild(f), e && h.appendChild(e);
    ...
    function b(a, c) {
        var d, e, f, g = a.nodeType,
            ...
            j = k[g],
            m = 0;
        if (p && 1 === g && wysihtml5.dom.hasClass(a, p)) return a;
        if (e = j && j(a), !e) {
            if (e === !1) {
                for (d = a.ownerDocument.createDocumentFragment(), m = i; m--;) f = b(h[m], c), f && d.insertBefore(f, d.firstChild);
                return wysihtml5.lang.array(["div", "pre", "p", "table", "td", "th", "ul", "ol", "li", "dd", "dl", "footer", "header", "section", "h1", "h2", "h3", "h4", "h5", "h6"]).contains(a.nodeName.toLowerCase()) && a.parentNode.lastChild !== a && (a.nextSibling && 3 === a.nextSibling.nodeType && /^\s/.test(a.nextSibling.nodeValue) || d.appendChild(a.ownerDocument.createTextNode(" "))), d.normalize && d.normalize(), d
            }
            return null
        }
        for (m = 0; i > m; m++) f = b(h[m], c), f && e.appendChild(f);
        if (c && e.nodeName.toLowerCase() === l && (!e.childNodes.length || /^\s*$/gi.test(e.innerHTML) && "_wysihtml5-temp-placeholder" !== a.className && "rangySelectionBoundary" !== a.className || !e.attributes.length)) {
            for (d = e.ownerDocument.createDocumentFragment(); e.firstChild;) d.appendChild(e.firstChild);
            return d.normalize && d.normalize(), d
        }
    ...
    function c(a) {
        ...
        if (i && "HTML" != i && (h = i + ":" + h), "outerHTML" in a && (wysihtml5.browser.autoClosesUnclosedTags() || "P" !== a.nodeName || "</p>" === a.outerHTML.slice(-4).toLowerCase() || (h = "div")), h in e) {
            if (b = e[h], !b || b.remove) return null;
            if (b.unwrap) return !1;
            b = "string" == typeof b ? {
                rename_tag: b
            } : b
        } else {
        ...
        return c = a.ownerDocument.createElement(b.rename_tag || h), g(a, c, b), f(a, c, b), b.one_of_type && !d(a, o, b.one_of_type) ? b.remove_action && "unwrap" == b.remove_action ? !1 : null : (a = null, c.normalize && c.normalize(), c)
    }

    function d(a, b, c) {
        var d, f;
        if ("SPAN" === a.nodeName && ("_wysihtml5-temp-placeholder" === a.className || "rangySelectionBoundary" === a.className)) return !0;
        for (f in c)
            if (c.hasOwnProperty(f) && b.type_definitions && b.type_definitions[f] && (d = b.type_definitions[f], e(a, d))) return !0;
        return !1
    }
    ...
    function g(a, b, c) {
        var d, e, f, g, i, j, k = {},
            ...
            z = [],
            A = [];
        if (q && (k = wysihtml5.lang.object(q).clone()), r)
            for (g in r){
                ...
                zz = (j == 'allow' ? h(a, g) : j(h(a, g)));
                if (typeof(zz) === "string") {
                    k[g] = zz;
                }


                //j = s[r[g]], j && (oldAttribute = h(a, g), (oldAttribute || "alt" === g && "IMG" == a.nodeName) && (i = j(oldAttribute), "string" == typeof i && (k[g] = i)));

            }
        if (l && x.push(l), n)
            for (g in n) j = u[n[g]], j && (f = j(h(a, g)), "string" == typeof f && x.push(f));
        if (p)
            for (g in p) j = t[p[g]], j && (newStyle = j(h(a, g)), "string" == typeof newStyle && y.push(newStyle));
        if ("string" == typeof v && "any" === v && a.getAttribute("class")) k["class"] = a.getAttribute("class");
        else {
            for (v["_wysihtml5-temp-placeholder"] = 1, v._rangySelectionBoundary = 1, A = a.getAttribute("class"), A && (x = x.concat(A.split(m))), d = x.length; d > w; w++) e = x[w], v[e] && z.push(e);
            z.length && (k["class"] = wysihtml5.lang.array(z).unique().join(" "))
        }
        y.length && (k.style = wysihtml5.lang.array(y).unique().join(" "));
        for (g in k) try {
            b.setAttribute(g, k[g])
        } catch (B) {}
        k.src && ("undefined" != typeof k.width && b.setAttribute("width", k.width), "undefined" != typeof k.height && b.setAttribute("height", k.height))
    }
    ...
    var a = function(a, b) {
        ...
        b = function(b, c, d) {
            ...
            if (b) {
                var f = wysihtml5.dom.getParentElement(b, {
                    nodeName: "LI"
                });
                otherNodeName = "UL" === c ? "OL" : "UL", a(b, c) ? e.el = b : a(b, otherNodeName) ? e = {
                    el: b,
                    other: !0
                } : f && (a(f.parentNode, c) ? e.el = f.parentNode : a(f.parentNode, otherNodeName) && (e = {
                    el: f.parentNode,
                    other: !0
                }))
            }
            return e.el && !d.element.contains(e.el) && (e.el = null), e
        },
        c = function(a, b, c) {
            var d, f = "UL" === b ? "OL" : "UL";
            c.selection.executeAndRestore(function() {
                var g = e(f, c);
                if (g.length)
                    for (var h = g.length; h--;) wysihtml5.dom.renameElement(g[h], b.toLowerCase());
                else {
                    d = e(["OL", "UL"], c);
                    for (var i = d.length; i--;) wysihtml5.dom.resolveList(d[i], c.config.useLineBreaks);
                    wysihtml5.dom.resolveList(a, c.config.useLineBreaks)
                }
            })
        },
        d = function(a, b, c) {
            var d = "UL" === b ? "OL" : "UL";
            c.selection.executeAndRestore(function() {
                for (var f = [a].concat(e(d, c)), g = f.length; g--;) wysihtml5.dom.renameElement(f[g], b.toLowerCase())
            })
        },
        e = function(b, c) {
        ...
        f = function(a, b) {
            b.selection.executeAndRestoreRangy(function() {
                var c, d, e = "_wysihtml5-temp-" + (new Date).getTime(),
                    f = b.selection.deblockAndSurround({
                        nodeName: "div",
                        className: e
                    }),
                    g = /\uFEFF/g;
                f.innerHTML = f.innerHTML.replace(g, ""), f && (c = wysihtml5.lang.array(["", "<br>", wysihtml5.INVISIBLE_SPACE]).contains(f.innerHTML), d = wysihtml5.dom.convertToList(f, a.toLowerCase(), b.parent.config.uneditableContainerClassname), c && b.selection.selectNode(d.querySelector("li"), !0))
            })
        };
    return {
        exec: function(a, e, g) {
            var h = a.doc,
                i = "OL" === g ? "insertorderedlist" : "insertunorderedlist",
                j = a.selection.getSelectedNode(),
                k = b(j, g, a);
            k.el ? k.other ? d(k.el, g, a) : c(k.el, g, a) : a.commands.support(i) ? h.execCommand(i, !1, null) : f(g, a)
        },
    ...
    function(a) {
        ...
        a.views.Composer = a.views.View.extend({
            ...
            getValue: function(b) {
                ...
                return b && (c = this.parent.parse(c)), c
            },
    ...
    function(a) {
        ...
        a.views.Composer.prototype.observe = function() {
            ...
            b.observe(k, m, function() {
                ...
                h !== e.getValue() && e.parent.fire("change").fire("change:composer"), e.parent.fire("blur").fire("blur:composer")
    ...
    function(a) {
        ...
        a.Editor = a.lang.Dispatcher.extend({
            ...
            parse: function(b) {
                var c = this.config.contentEditableMode ? document : this.composer.sandbox.getDocument(),
                    d = this.config.parser(b, {
                        rules: this.config.parserRules,
                        cleanUp: this.config.cleanUp,
                        context: c,
                        uneditableClass: this.config.uneditableContainerClassname
                    });
                return "object" == typeof b && a.quirks.redraw(b), d
            },

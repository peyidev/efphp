<section id="resources">
  <div class="container p-t-lg">
    <div class="row">
      ...
      <div class="col-sm-12">
        <div class="r-tweb  wow fadeIn" data-wow-duration="1000ms" data-wow-delay="600ms">
          <a href="https://mhmprop.twa.rentmanager.com/"><span>Tenant WEB</span><label>ACCESS</label></a>
        </div>
      </div>

      <div class="col-lg-6 col-sm-6 r-l-content">
        <h3>Real Estate Co.</h3>
        <p>
          Please contact us at accounts@mhmproperties.com with any questions regarding Tenant Web Access Portal. Click here to view
          <a href="https://mhmprop.twa.rentmanager.com/">Tenant Web Access</a>
        </p>
        <div class="resources-contacts">
          <p><i class="fa fa-envelope r-c-mail"></i>contact@mhmproperties.com</p>
          <p><i class="fa fa-phone r-c-cel"></i>217-337-8852</p>
          <p><i class="fa fa-laptop r-c-url"></i>www.mhmproperties.com</p>
          <p><i class="fa fa-fax r-c-fax"></i>217-841-5407</p>
        </div>
      </div>
...
<section id="resources-maintenance">
  <div class="container animate-in p-t-lg p-d-xl">
    <div class="row">
      <div class="col-lg-6 col-sm-6 r-l-content slide-text">
        ...
        <p class="Title"><em>ADDRESS:</em> 303 S Fifth Street, Champaign, IL<br>
          ...
          <em>HOURS</em>: 9am &ndash; 5pm (M-F) &ndash; Office visits by appointment only
        </p>
      </div>
      <div class="col-lg-6 col-sm-6">
        <div id="gmap"></div>

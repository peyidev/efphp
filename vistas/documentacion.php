<div id="hero-internal">
    <div class="jumbotron" >
        <div class="dynamic-height-internal">
            <h1>Documentación efphp</h1>
            <p class="lead">Pues estamos trabajando en una documentación mucho más completa, esperamos te sirva esta.</p>
        </div>
    </div>
</div>
...
<section id="main_content">
    <h1>
        <a aria-hidden="true" href="#ephp" class="anchor" id="ephp"><span class="octicon octicon-link" aria-hidden="true"></span></a>Documentación</h1>

    <h2>
        <a aria-hidden="true" href="#easyphp-documentaci%C3%B3n" class="anchor" id="easyphp-documentación"><span class="octicon octicon-link" aria-hidden="true"></span></a>EasyPhp</h2>
